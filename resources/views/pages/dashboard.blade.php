            ...
            <div class="col-lg-7 mb-lg-0 mb-4">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize">pERFOMANCE overview</h6>
                                    ...
                                    <td class="w-30">
                                        <div class="d-flex px-2 py-1 align-items-center">
                                            ...
                                            <div class="ms-4">
                                                ...
                                                <h6 class="text-sm mb-0">{{ $student->name }}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-center">
                                            ...
                                            <h6 class="text-sm mb-0">{{ $student->class->name }}</h6>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-center">
                                            
                                            <h6 class="text-sm mb-0">{{ $student->parent }}</h6>
                                        </div>
                                    </td>
                                    <td class="align-middle text-sm">
                                        <div class="col text-center">
                                            
                                            <h6 class="text-sm mb-0">{{ $student->age }}</h6>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach    
